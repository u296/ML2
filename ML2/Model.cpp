...
namespace ML2
{
	...
	{
		Initialize(inputVariables, modelShape, groupingFunctions, activationFunctions);
	}
	...
	ML2::Cells::Cell Model::operator[](int index) const	// Getter
	{
		return ML2::Cells::Cell();
	}

	ML2::Cells::Cell & Model::operator[](int index)	// Setter
	{
		// TODO: insert return statement here
	}

	void Model::Initialize(std::vector<double *> inputVariables, std::vector<int> modelShape, std::vector<double(*)(std::vector<double>)> groupingFunctions, std::vector<double(*)(double)> activationFunctions)
	{
